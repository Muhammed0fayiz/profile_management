    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-5xl aspect-video rounded-2xl overflow-hidden shadow-xl">
        ...
        <div className="absolute bottom-4 right-4 flex items-center space-x-2">
          <button className="bg-white bg-opacity-30 hover:bg-opacity-50 backdrop-blur-md text-white px-5 py-2 rounded-lg flex items-center space-x-2 transition-all duration-200 text-sm sm:text-base">
